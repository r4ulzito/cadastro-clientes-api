package br.com.cadastro.cliente.api.domain.handler;

import br.com.cadastro.cliente.api.domain.handler.response.BeanValidationResponseCustomizada;
import br.com.cadastro.cliente.api.domain.exception.NullQueryException;
import br.com.cadastro.cliente.api.domain.handler.response.ExceptionResponsePadrao;
